...
$SQLquery = "INSERT INTO objects (idobjects, adress, square, room, floors, description, price, predoplata, free, idowner) VALUES ((SELECT max(idobjects) from (Select idobjects from objects))+1, '$adress',$square,$room,$floors,'$description',$price,$predoplata,$free,$idowner)";
echo '<BR> SQL query: ';
echo $SQLquery;
